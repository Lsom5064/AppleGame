export const BOARD_WIDTH = 820;
export const BOARD_HEIGHT = 590;
...
export const APPLE_START_X = 100;
export const APPLE_START_Y = 104;
export const APPLE_SPACING_X = 38;
export const APPLE_SPACING_Y = 43;
