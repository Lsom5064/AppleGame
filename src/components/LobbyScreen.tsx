  ...
  return (
    <div className={styles.layout}>
      ...
      <div className={styles.rulesFooter}>
        <p className={styles.rulesText}>제한시간은 120초입니다.</p>
        <p className={styles.rulesText}>드래그한 범위의 숫자 합이 10이면 사과가 제거됩니다.</p>
        <p className={styles.rulesText}>사과 1개당 1점이며, 모두 제거하면 클리어 시간이 기록됩니다.</p>
